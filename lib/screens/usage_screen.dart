...
class MessagesStream extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore.collection("Usage").orderBy("timestamp").snapshots(),
      builder: (context, snapshot) {
        ...
        for (var message in messages) {
          final messageText = message.data['Waterusage'];
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Center(
                    child: Text(
                      'Your consumption today is$text liter '
                      'Thanks for using our serves',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 16.0,
                        letterSpacing: 2,
